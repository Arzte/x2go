...
static const char qt_meta_stringdata_AppDialog[] = {
    "AppDialog\0\0slotSelectedChanged()\0"
    "slotStartSelected()\0item\0"
    "slotDoubleClicked(QTreeWidgetItem*)\0"
    "text\0slotSearchChanged(QString)\0"
};
...
void AppDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotSelectedChanged(); break;
        case 1: _t->slotStartSelected(); break;
        case 2: _t->slotDoubleClicked((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        case 3: _t->slotSearchChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *AppDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_AppDialog"))
        return static_cast< Ui_AppDialog*>(const_cast< AppDialog*>(this));
