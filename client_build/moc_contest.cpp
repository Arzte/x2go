...
static const char qt_meta_stringdata_ConTest[] = {
    "ConTest\0\0slotConnected()\0socketError\0"
    "slotError(QAbstractSocket::SocketError)\0"
    "slotTimer()\0msecElapsed,bytesRecived\0"
    "slotConSpeed(int,int)\0start()\0"
};
...
void ConTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slotTimer(); break;
        case 3: _t->slotConSpeed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
...
void *ConTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_ConTest"))
        return static_cast< Ui_ConTest*>(const_cast< ConTest*>(this));
