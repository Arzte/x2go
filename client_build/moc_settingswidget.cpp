...
static const char qt_meta_stringdata_SettingsWidget[] = {
    "SettingsWidget\0\0server,port,user\0"
    "setServerSettings(QString,QString,QString)\0"
    "updateCmdLine()\0slot_identDisplays()\0"
    "slot_hideIdentWins()\0slot_kbdClicked()\0"
};
...
void SettingsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setServerSettings((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        case 1: _t->updateCmdLine(); break;
        case 2: _t->slot_identDisplays(); break;
        case 3: _t->slot_hideIdentWins(); break;
        case 4: _t->slot_kbdClicked(); break;
        default: ;
        }
    }
}
...
const QMetaObject SettingsWidget::staticMetaObject = {
    { &ConfigWidget::staticMetaObject, qt_meta_stringdata_SettingsWidget,
