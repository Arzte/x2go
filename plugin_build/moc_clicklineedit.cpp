/****************************************************************************
** Meta object code from reading C++ file 'clicklineedit.h'
**
...
#include "../src/clicklineedit.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'clicklineedit.h' doesn't include <QObject>."
...
void ClickLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ClickLineEdit *_t = static_cast<ClickLineEdit *>(_o);
        switch (_id) {
